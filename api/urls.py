...
Maps endpoints to their respective view functions.
"""
...
urlpatterns = [
    ...
    path('evaluate-point/', optimization.evaluate_point_inputs, name='evaluate_point_inputs'),
    path('get-chart-data/', optimization.get_chart_data, name='get_chart_data'),
    ...
    path('clear-chat-history/', chatbot.clear_chat_history, name='clear_chat_history'),
