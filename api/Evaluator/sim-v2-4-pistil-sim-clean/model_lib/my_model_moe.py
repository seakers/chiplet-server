...
from model_lib.nn.transformer_layer_moe import TransformerLayerMoE
...
class MyLLMMoE:
    def __init__(self, llm_manager):
        ...
        self.no_rope_layers         = llm_manager.no_rope_layers
        self.max_seq_len            = llm_manager.max_seq_len           # full attention layer
        self.attention_chunk_size   = llm_manager.attention_chunk_size  # chunked attention layer

        # MoE / MLP Specific
        self.num_experts_per_tok    = llm_manager.num_experts_per_tok
        self.num_local_experts      = llm_manager.num_local_experts
        self.ff_dim_moe             = llm_manager.ff_dim_moe
        self.ff_dim_mlp             = llm_manager.ff_dim_mlp
        self.moe_layers             = llm_manager.moe_layers
